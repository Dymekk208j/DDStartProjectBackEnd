...
namespace DDStartProjectBackEnd.Auth.Data
{
    public class CustomUserStore : IUserStore<User>, IUserPasswordStore<User>, IDisposable, IUserEmailStore<User>
    {
        ...
        public CustomUserStore(IDbConnection dbConnection, IPasswordHasher<User> passwordHasher)
        {
        ...
        public async Task<IdentityResult> CreateAsync(User user, CancellationToken cancellationToken)
        {
            using (var conn = _dbConnection.GetConnection)
            {
                var query = $"INSERT INTO [AspNetUsers](" +
                    ...
                    $"[PasswordHash],[SecurityStamp],[ConcurrencyStamp],[PhoneNumber],[PhoneNumberConfirmed],[TwoFactorEnabled],[LockoutEnd],[LockoutEnabled],[AccessFailedCount],[Firstname],[Lastname],[Gender]" +
                    $")" +
                    ...
                    $"@TwoFactorEnabled,@LockoutEnd,@LockoutEnabled,@AccessFailedCount,@Firstname,@Lastname,@Gender)";
        ...
        public async Task<User> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken)
        {
            using (var conn = _dbConnection.GetConnection)
            {
                const string query = "SELECT * " +
                                                     ...
                                                     "WHERE [NormalizedEmail] = @NormalizedEmail;"; var param = new DynamicParameters();
